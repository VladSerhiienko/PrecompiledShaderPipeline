...
layout( constant_id = 2 ) const float kUnusedScalar = 1.0;
...
layout( std140, set = 1, binding = 0 ) uniform ObjectUBO {
    ...
    vec3 OtherPositionOffset;
    vec4 PositionOffset;
    float OtherPositionScale;
    vec4 PositionScale;
    vec4 TexcoordOffsetScale;
    SampleStruct OtherSampleStruct;
    float OtherTexcoordOffsetScale;
};
