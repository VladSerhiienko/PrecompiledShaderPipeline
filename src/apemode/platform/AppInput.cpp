...
AppInput::AppInput()
    ...
    TouchIdCount = 0;
    for (auto& TouchId : TouchIds) TouchId = sInvalidTouchValue;
}

AppInput::~AppInput() {}

bool AppInput::IsTouchEnabled() const { return bIsUsingTouch; }
...
uint32_t AppInput::GetTouchCount() const { return TouchIdCount; }

bool AppInput::IsAnyPressed() const { return bIsAnyPressed; }

bool AppInput::IsTrackingTouchesOrMousePressed() const { return bIsTrackingTouchesOrMousePressed; }

bool AppInput::IsPressed(DigitalInputUInt InDigitalInput) const { return Buttons[0][InDigitalInput]; }
...
bool AppInput::IsReleased(DigitalInputUInt InDigitalInput) const { return !Buttons[0][InDigitalInput]; }

bool AppInput::IsFirstReleased(DigitalInputUInt InDigitalInput) const {
    return !Buttons[0][InDigitalInput] && Buttons[1][InDigitalInput];
}

float AppInput::GetDurationPressed(DigitalInputUInt InDigitalInput) const { return HoldDuration[InDigitalInput]; }

float AppInput::GetAnalogInput(AnalogInputUInt InAnalogInput) const { return Analogs[InAnalogInput]; }