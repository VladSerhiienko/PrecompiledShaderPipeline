...
int main(int argc, char** ppArgs) {
    std::unique_ptr<apemode::platform::IAppShell> appShell(
        apemode::viewer::vk::CreateViewer(argc, (const char**)ppArgs));
    if (!appShell) { return -1; }

    apemode::platform::sdl2::AppSurface appSurfaceSdl;
    if (!appSurfaceSdl.Initialize(1280, 800, "Viewer")) { return -1; }
    ...
    // assetManager.AddAsset( "shared/scene.fbxp",
    // "C:/Sources/Models/FbxPipelineDrc/soul-of-cinder-dark-souls-3-boss-tilt-brush.fbxp" ); assetManager.AddAsset(
    // "shared/scene.fbxp", "C:/Sources/Models/FbxPipelineDrc/hurricane-maria.fbxp" ); assetManager.AddAsset(
    // "shared/scene.fbxp", "C:/Sources/Models/FbxPipelineDrc/Aston Martin Vantage.fbxp" ); assetManager.AddAsset(
    // "shared/scene.fbxp", "C:/Sources/Models/FbxPipelineDrc/commander-saru.fbxp" ); assetManager.AddAsset(
    // "shared/scene.fbxp", "C:/Sources/Models/FbxPipelineDrc/zbrush-for-concept-mech-design-dver.fbxp" );
    ...
    // assetManager.AddAsset( "shared/scene.fbxp",
    // "C:/Sources/Models/FbxPipelineDrc/2085-restomod-jetvette-free-download.fbxp" ); assetManager.AddAsset(
    // "shared/scene.fbxp", "C:/Sources/Models/FbxPipelineDrc/lamborghini+urus.fbxp" ); assetManager.AddAsset(
    // "shared/scene.fbxp", "C:/Sources/Models/FbxPipelineDrc/Macan+Hamann.fbxp" ); assetManager.AddAsset(
    // "shared/scene.fbxp", "C:/Sources/Models/FbxPipelineDrc/run-hedgehog-run.fbxp" );
