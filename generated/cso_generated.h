...
inline const char *EnumNameEVersionFb(EVersionFb e) {
  if (e < EVersionFb_Value || e > EVersionFb_Value) return "";
...
inline flatbuffers::Offset<CompiledShaderFb> CreateCompiledShaderFbDirect(
  ...
  auto spv__ = spv ? _fbb.CreateVector<uint32_t>(*spv) : 0;
...
inline flatbuffers::Offset<CollectionFb> CreateCollectionFb(
    flatbuffers::FlatBufferBuilder &_fbb,
    EVersionFb version = EVersionFb_Value,
...
inline flatbuffers::Offset<CollectionFb> CreateCollectionFbDirect(
  ...
  auto csos__ = csos ? _fbb.CreateVector<flatbuffers::Offset<CompiledShaderFb>>(*csos) : 0;
...
inline const csofb::CollectionFb *GetSizePrefixedCollectionFb(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<csofb::CollectionFb>(buf);
}
...
inline bool VerifySizePrefixedCollectionFbBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<csofb::CollectionFb>(CollectionFbIdentifier());
}
...
inline void FinishSizePrefixedCollectionFbBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<csofb::CollectionFb> root) {
  fbb.FinishSizePrefixed(root, CollectionFbIdentifier());
}
