...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4) CompiledShader FLATBUFFERS_FINAL_CLASS {
 private:
  ...
  uint32_t compiled_hlsl_string_index_;
  uint32_t type_;
 ...
 public:
  ...
  CompiledShader(uint32_t _compiled_buffer_index, uint32_t _reflected_shader_index, uint32_t _preprocessed_string_index, uint32_t _assembly_string_index, uint32_t _compiled_glsl_vulkan_string_index, uint32_t _compiled_glsl_es2_string_index, uint32_t _compiled_glsl_es3_string_index, uint32_t _compiled_msl_ios_string_index, uint32_t _compiled_msl_macos_string_index, uint32_t _compiled_hlsl_string_index, IR _type)
      : compiled_buffer_index_(flatbuffers::EndianScalar(_compiled_buffer_index)),
        ...
        compiled_hlsl_string_index_(flatbuffers::EndianScalar(_compiled_hlsl_string_index)),
  ...
  uint32_t compiled_hlsl_string_index() const {
    return flatbuffers::EndianScalar(compiled_hlsl_string_index_);
  }
  void mutate_compiled_hlsl_string_index(uint32_t _compiled_hlsl_string_index) {
    flatbuffers::WriteScalar(&compiled_hlsl_string_index_, _compiled_hlsl_string_index);
  }
  IR type() const {
...
FLATBUFFERS_STRUCT_END(CompiledShader, 44);
...
struct ReflectedShader FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_STAGE_INPUT_STATE_INDICES = 28,
    VT_STAGE_OUTPUT_STATE_INDICES = 30,
    VT_UNIFORM_BUFFER_STATE_INDICES = 32,
    VT_PUSH_CONSTANT_BUFFER_STATE_INDICES = 34,
    VT_SAMPLED_IMAGE_STATE_INDICES = 36,
    VT_SUBPASS_INPUT_STATE_INDICES = 38,
    VT_IMAGE_STATE_INDICES = 40,
    VT_SAMPLER_STATE_INDICES = 42,
    VT_STORAGE_IMAGE_STATE_INDICES = 44,
    VT_STORAGE_BUFFER_STATE_INDICES = 46
  };
  uint32_t name_index() const {
    return GetField<uint32_t>(VT_NAME_INDEX, 0);
  }
  ...
  const flatbuffers::Vector<uint32_t> *stage_input_state_indices() const {
    return GetPointer<const flatbuffers::Vector<uint32_t> *>(VT_STAGE_INPUT_STATE_INDICES);
  }
  flatbuffers::Vector<uint32_t> *mutable_stage_input_state_indices() {
    return GetPointer<flatbuffers::Vector<uint32_t> *>(VT_STAGE_INPUT_STATE_INDICES);
  }
  const flatbuffers::Vector<uint32_t> *stage_output_state_indices() const {
    return GetPointer<const flatbuffers::Vector<uint32_t> *>(VT_STAGE_OUTPUT_STATE_INDICES);
  }
  flatbuffers::Vector<uint32_t> *mutable_stage_output_state_indices() {
    return GetPointer<flatbuffers::Vector<uint32_t> *>(VT_STAGE_OUTPUT_STATE_INDICES);
  }
  ...
  const flatbuffers::Vector<uint32_t> *sampled_image_state_indices() const {
    return GetPointer<const flatbuffers::Vector<uint32_t> *>(VT_SAMPLED_IMAGE_STATE_INDICES);
  }
  flatbuffers::Vector<uint32_t> *mutable_sampled_image_state_indices() {
    return GetPointer<flatbuffers::Vector<uint32_t> *>(VT_SAMPLED_IMAGE_STATE_INDICES);
  }
  const flatbuffers::Vector<uint32_t> *subpass_input_state_indices() const {
    return GetPointer<const flatbuffers::Vector<uint32_t> *>(VT_SUBPASS_INPUT_STATE_INDICES);
  }
  flatbuffers::Vector<uint32_t> *mutable_subpass_input_state_indices() {
    return GetPointer<flatbuffers::Vector<uint32_t> *>(VT_SUBPASS_INPUT_STATE_INDICES);
  }
  const flatbuffers::Vector<uint32_t> *image_state_indices() const {
    return GetPointer<const flatbuffers::Vector<uint32_t> *>(VT_IMAGE_STATE_INDICES);
  }
  flatbuffers::Vector<uint32_t> *mutable_image_state_indices() {
    return GetPointer<flatbuffers::Vector<uint32_t> *>(VT_IMAGE_STATE_INDICES);
  }
  const flatbuffers::Vector<uint32_t> *sampler_state_indices() const {
    return GetPointer<const flatbuffers::Vector<uint32_t> *>(VT_SAMPLER_STATE_INDICES);
  }
  flatbuffers::Vector<uint32_t> *mutable_sampler_state_indices() {
    return GetPointer<flatbuffers::Vector<uint32_t> *>(VT_SAMPLER_STATE_INDICES);
  }
  const flatbuffers::Vector<uint32_t> *storage_image_state_indices() const {
    return GetPointer<const flatbuffers::Vector<uint32_t> *>(VT_STORAGE_IMAGE_STATE_INDICES);
  }
  flatbuffers::Vector<uint32_t> *mutable_storage_image_state_indices() {
    return GetPointer<flatbuffers::Vector<uint32_t> *>(VT_STORAGE_IMAGE_STATE_INDICES);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_STAGE_INPUT_STATE_INDICES) &&
           verifier.VerifyVector(stage_input_state_indices()) &&
           VerifyOffset(verifier, VT_STAGE_OUTPUT_STATE_INDICES) &&
           verifier.VerifyVector(stage_output_state_indices()) &&
           ...
           VerifyOffset(verifier, VT_SAMPLED_IMAGE_STATE_INDICES) &&
           verifier.VerifyVector(sampled_image_state_indices()) &&
           VerifyOffset(verifier, VT_SUBPASS_INPUT_STATE_INDICES) &&
           verifier.VerifyVector(subpass_input_state_indices()) &&
           VerifyOffset(verifier, VT_IMAGE_STATE_INDICES) &&
           verifier.VerifyVector(image_state_indices()) &&
           VerifyOffset(verifier, VT_SAMPLER_STATE_INDICES) &&
           verifier.VerifyVector(sampler_state_indices()) &&
           VerifyOffset(verifier, VT_STORAGE_IMAGE_STATE_INDICES) &&
           verifier.VerifyVector(storage_image_state_indices()) &&
...
struct ReflectedShaderBuilder {
  ...
  void add_stage_input_state_indices(flatbuffers::Offset<flatbuffers::Vector<uint32_t>> stage_input_state_indices) {
    fbb_.AddOffset(ReflectedShader::VT_STAGE_INPUT_STATE_INDICES, stage_input_state_indices);
  }
  void add_stage_output_state_indices(flatbuffers::Offset<flatbuffers::Vector<uint32_t>> stage_output_state_indices) {
    fbb_.AddOffset(ReflectedShader::VT_STAGE_OUTPUT_STATE_INDICES, stage_output_state_indices);
  }
  ...
  void add_sampled_image_state_indices(flatbuffers::Offset<flatbuffers::Vector<uint32_t>> sampled_image_state_indices) {
    fbb_.AddOffset(ReflectedShader::VT_SAMPLED_IMAGE_STATE_INDICES, sampled_image_state_indices);
  }
  void add_subpass_input_state_indices(flatbuffers::Offset<flatbuffers::Vector<uint32_t>> subpass_input_state_indices) {
    fbb_.AddOffset(ReflectedShader::VT_SUBPASS_INPUT_STATE_INDICES, subpass_input_state_indices);
  }
  void add_image_state_indices(flatbuffers::Offset<flatbuffers::Vector<uint32_t>> image_state_indices) {
    fbb_.AddOffset(ReflectedShader::VT_IMAGE_STATE_INDICES, image_state_indices);
  }
  void add_sampler_state_indices(flatbuffers::Offset<flatbuffers::Vector<uint32_t>> sampler_state_indices) {
    fbb_.AddOffset(ReflectedShader::VT_SAMPLER_STATE_INDICES, sampler_state_indices);
  }
  void add_storage_image_state_indices(flatbuffers::Offset<flatbuffers::Vector<uint32_t>> storage_image_state_indices) {
    fbb_.AddOffset(ReflectedShader::VT_STORAGE_IMAGE_STATE_INDICES, storage_image_state_indices);
  }
...
inline flatbuffers::Offset<ReflectedShader> CreateReflectedShader(
    ...
    flatbuffers::Offset<flatbuffers::Vector<uint32_t>> stage_input_state_indices = 0,
    flatbuffers::Offset<flatbuffers::Vector<uint32_t>> stage_output_state_indices = 0,
    ...
    flatbuffers::Offset<flatbuffers::Vector<uint32_t>> sampled_image_state_indices = 0,
    flatbuffers::Offset<flatbuffers::Vector<uint32_t>> subpass_input_state_indices = 0,
    flatbuffers::Offset<flatbuffers::Vector<uint32_t>> image_state_indices = 0,
    flatbuffers::Offset<flatbuffers::Vector<uint32_t>> sampler_state_indices = 0,
    flatbuffers::Offset<flatbuffers::Vector<uint32_t>> storage_image_state_indices = 0,
  ...
  builder_.add_storage_image_state_indices(storage_image_state_indices);
  builder_.add_sampler_state_indices(sampler_state_indices);
  builder_.add_image_state_indices(image_state_indices);
  builder_.add_subpass_input_state_indices(subpass_input_state_indices);
  builder_.add_sampled_image_state_indices(sampled_image_state_indices);
  ...
  builder_.add_stage_output_state_indices(stage_output_state_indices);
  builder_.add_stage_input_state_indices(stage_input_state_indices);
...
inline flatbuffers::Offset<ReflectedShader> CreateReflectedShaderDirect(
    ...
    const std::vector<uint32_t> *stage_input_state_indices = nullptr,
    const std::vector<uint32_t> *stage_output_state_indices = nullptr,
    ...
    const std::vector<uint32_t> *sampled_image_state_indices = nullptr,
    const std::vector<uint32_t> *subpass_input_state_indices = nullptr,
    const std::vector<uint32_t> *image_state_indices = nullptr,
    const std::vector<uint32_t> *sampler_state_indices = nullptr,
    const std::vector<uint32_t> *storage_image_state_indices = nullptr,
  ...
  auto stage_input_state_indices__ = stage_input_state_indices ? _fbb.CreateVector<uint32_t>(*stage_input_state_indices) : 0;
  auto stage_output_state_indices__ = stage_output_state_indices ? _fbb.CreateVector<uint32_t>(*stage_output_state_indices) : 0;
  ...
  auto sampled_image_state_indices__ = sampled_image_state_indices ? _fbb.CreateVector<uint32_t>(*sampled_image_state_indices) : 0;
  auto subpass_input_state_indices__ = subpass_input_state_indices ? _fbb.CreateVector<uint32_t>(*subpass_input_state_indices) : 0;
  auto image_state_indices__ = image_state_indices ? _fbb.CreateVector<uint32_t>(*image_state_indices) : 0;
  auto sampler_state_indices__ = sampler_state_indices ? _fbb.CreateVector<uint32_t>(*sampler_state_indices) : 0;
  auto storage_image_state_indices__ = storage_image_state_indices ? _fbb.CreateVector<uint32_t>(*storage_image_state_indices) : 0;
  ...
  return cso::CreateReflectedShader(
      ...
      stage_input_state_indices__,
      stage_output_state_indices__,
      uniform_buffer_state_indices__,
      push_constant_buffer_state_indices__,
      sampled_image_state_indices__,
      subpass_input_state_indices__,
      image_state_indices__,
      sampler_state_indices__,
      storage_image_state_indices__,
